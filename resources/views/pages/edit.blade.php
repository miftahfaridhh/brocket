                    ...
                    <div class="col-md-6">
                        <form method="POST" action="/editbracket">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                <input type="number" name="gold_medal" class="form-control" id="gold" placeholder="Input New Gold Medal">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="silver" class="col-sm-2 col-form-label">Silver Medal</label>
                                <div class="col-sm-10">
                                <input type="number" name="silver_medal" class="form-control" id="silver" placeholder="Input New Silver Medal">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="bronze" class="col-sm-2 col-form-label">Bronze Medal</label>
                                <div class="col-sm-10">
                                <input type="number" name="bronze_medal" class="form-control" id="bronze" placeholder="Input New Bronze Medal">
                                </div>
                            </div>
